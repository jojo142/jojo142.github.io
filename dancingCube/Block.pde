...
colorTwo=selectColor;
  ...
  void moveRandom() {
    ...
    rotation.x=rotation.x+(randomRotation.x-rotation.x)*0.01;
    rotation.y=rotation.y+(randomRotation.y-rotation.y)*0.01;
    rotation.z=rotation.z+(randomRotation.z-rotation.z)*0.01;
  }
  void moveReset() {  
